/**
 * MediaPanel — African & international business news channels.
 * Link-only: embeds are unreliable across these sources.
 */
...
interface Channel {
  ...
  description: string
  watchUrl:    string
  tag?:        string  // optional badge e.g. "24/7 LIVE"
}
...
const CHANNELS: Channel[] = [
  {
    ...
    flag:        '🇶🇦',
    description: '24/7 English news — comprehensive Africa and Middle East coverage.',
  ...
  },
  {
    ...
    region:      'Global / Africa',
    flag:        '🇬🇧',
    description: 'Global news with strong Africa Bureau reporting. Business and markets.',
  ...
  },
  {
    ...
    region:      'Pan-African',
    flag:        '🌍',
    description: 'Sub-Saharan markets and business — JSE, NGX, NSE coverage.',
  ...
  },
  {
    ...
    region:      'Global / Africa',
    flag:        '🇺🇸',
    description: 'Global markets and finance. Africa Equity Report airs weekdays.',
        ...
        {CHANNELS.map(c => (
          ...
          >
            <div className="mp-card-top">
              <span className="mp-flag">{c.flag}</span>
              <div className="mp-info">
                <span className="mp-name">{c.shortName}</span>
                <span className="mp-region">{c.region}</span>
              </div>
              {c.tag && <span className="mp-tag">{c.tag}</span>}
            </div>
            <p className="mp-desc">{c.description}</p>
