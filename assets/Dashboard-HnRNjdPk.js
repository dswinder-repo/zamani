import{j as e,r as v,k as C,e as p,u as D}from"./vendor-9MAh3nQh.js";import{c as G,u as T,p as u,S as E,X as q,g as R,a as B,T as W,b as K}from"./index-BuAsym15.js";import{N as U,I as $,T as Y}from"./NdebelePanel-C_YHhQqb.js";import{F as O}from"./ForexTable-CuCchoPr.js";import{S as X}from"./Sparkline-Sa5-OsUq.js";import{P as A}from"./plus-CgSs3b-4.js";import{R as _,L as J,C as Z,X as H,Y as V,T as Q,a as ee}from"./recharts-DK6PfPlO.js";import{T as oe}from"./trending-down-3MUKzSbF.js";import"./store-DR-NtvzW.js";const re=[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]],ae=G("chevron-down",re);const te=[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]],se=G("chevron-up",te),le=["surge","jump","gain","rise","record","profit","growth","strong","beat","higher","boost","rally","soar","climb","outperform","upgrade","buy"],ie=["drop","fall","plunge","lose","decline","loss","weak","miss","lower","cut","recession","crash","sell-off","downgrade","warning","risk","concern"];function ne(o){const r=o.toLowerCase();return le.some(a=>r.includes(a))?"pos":ie.some(a=>r.includes(a))?"neg":null}function ce(o){const r=Date.now()-o,a=Math.floor(r/6e4);if(a<60)return`${a}m`;const n=Math.floor(a/60);return n<24?`${n}h`:`${Math.floor(n/24)}d`}function de({items:o}){return e.jsxs("div",{className:"panel news-feed",children:[o.map(r=>{const a=ne(r.headline);return e.jsxs("a",{className:"news-item",href:r.url,target:"_blank",rel:"noopener",children:[e.jsxs("div",{className:"news-meta",children:[e.jsx("span",{className:"news-source",children:r.source}),r.exchange&&e.jsx("span",{className:"news-tag",children:r.exchange}),a==="pos"&&e.jsx("span",{className:"news-sent pos",children:"▲"}),a==="neg"&&e.jsx("span",{className:"news-sent neg",children:"▼"}),e.jsx("span",{className:"news-time",children:ce(r.publishedAt)})]}),e.jsx("div",{className:"news-headline",children:r.headline})]},r.id)}),e.jsx("style",{children:`
