import{j as e,r as v,k as S,e as x,u as D}from"./vendor-9MAh3nQh.js";import{c as C,u as E,p as u,S as T,X as q,g as R,a as U,T as $,b as K}from"./index-C7rZDH3k.js";import{N as Y,I as B,T as W}from"./NdebelePanel-C_YHhQqb.js";import{F as O}from"./ForexTable-CuCchoPr.js";import{S as _}from"./Sparkline-Sa5-OsUq.js";import{P as F}from"./plus-B-8235SD.js";import{R as X,L as J,C as V,X as Z,Y as Q,T as H,a as ee}from"./recharts-DK6PfPlO.js";import{T as oe}from"./trending-down-BhAdnRrj.js";import"./store-DR-NtvzW.js";const re=[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]],ae=C("chevron-down",re);const te=[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]],se=C("chevron-up",te),le=["surge","jump","gain","rise","record","profit","growth","strong","beat","higher","boost","rally","soar","climb","outperform","upgrade","buy"],ne=["drop","fall","plunge","lose","decline","loss","weak","miss","lower","cut","recession","crash","sell-off","downgrade","warning","risk","concern"];function ie(o){const r=o.toLowerCase();return le.some(a=>r.includes(a))?"pos":ne.some(a=>r.includes(a))?"neg":null}function ce(o){const r=Date.now()-o,a=Math.floor(r/6e4);if(a<60)return`${a}m`;const n=Math.floor(a/60);return n<24?`${n}h`:`${Math.floor(n/24)}d`}function de({items:o}){return e.jsxs("div",{className:"panel news-feed",children:[o.map(r=>{const a=ie(r.headline);return e.jsxs("a",{className:"news-item",href:r.url,target:"_blank",rel:"noopener",children:[e.jsxs("div",{className:"news-meta",children:[e.jsx("span",{className:"news-source",children:r.source}),r.exchange&&e.jsx("span",{className:"news-tag",children:r.exchange}),a==="pos"&&e.jsx("span",{className:"news-sent pos",children:"▲"}),a==="neg"&&e.jsx("span",{className:"news-sent neg",children:"▼"}),e.jsx("span",{className:"news-time",children:ce(r.publishedAt)})]}),e.jsx("div",{className:"news-headline",children:r.headline})]},r.id)}),e.jsx("style",{children:`
