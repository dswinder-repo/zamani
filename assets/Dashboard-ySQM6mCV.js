import{j as e,r as v,k as C,e as p,u as D}from"./vendor-9MAh3nQh.js";import{c as I,u as T,p as u,S as E,X as q,g as R,a as B,T as W,b as K}from"./index-CXUK-kK_.js";import{N as U,I as $,T as Y}from"./NdebelePanel-C_YHhQqb.js";import{F as O}from"./ForexTable-CuCchoPr.js";import{S as X}from"./Sparkline-Sa5-OsUq.js";import{P as A}from"./plus-DOfc3eX6.js";import{R as _,L as J,C as Z,X as H,Y as V,T as Q,a as ee}from"./recharts-DK6PfPlO.js";import{T as oe}from"./trending-down-B6I3o9dc.js";import"./store-DR-NtvzW.js";const re=[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]],ae=I("chevron-down",re);const te=[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]],se=I("chevron-up",te),le=["surge","jump","gain","rise","record","profit","growth","strong","beat","higher","boost","rally","soar","climb","outperform","upgrade","buy"],ie=["drop","fall","plunge","lose","decline","loss","weak","miss","lower","cut","recession","crash","sell-off","downgrade","warning","risk","concern"];function ne(o){const r=o.toLowerCase();return le.some(a=>r.includes(a))?"pos":ie.some(a=>r.includes(a))?"neg":null}function ce(o){const r=Date.now()-o,a=Math.floor(r/6e4);if(a<60)return`${a}m`;const n=Math.floor(a/60);return n<24?`${n}h`:`${Math.floor(n/24)}d`}function de({items:o}){return e.jsxs("div",{className:"panel news-feed",children:[o.map(r=>{const a=ne(r.headline);return e.jsxs("a",{className:"news-item",href:r.url,target:"_blank",rel:"noopener",children:[e.jsxs("div",{className:"news-meta",children:[e.jsx("span",{className:"news-source",children:r.source}),r.exchange&&e.jsx("span",{className:"news-tag",children:r.exchange}),a==="pos"&&e.jsx("span",{className:"news-sent pos",children:"▲"}),a==="neg"&&e.jsx("span",{className:"news-sent neg",children:"▼"}),e.jsx("span",{className:"news-time",children:ce(r.publishedAt)})]}),e.jsx("div",{className:"news-headline",children:r.headline})]},r.id)}),e.jsx("style",{children:`
      ...
      `})]})}const me=new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function pe(o){return o>=1e3?new Intl.NumberFormat("en-US",{maximumFractionDigits:0}).format(o):me.format(o)}function he({items:o}){return e.jsxs("div",{className:"comm-table",children:[o.map(r=>e.jsxs("div",{className:"comm-row",children:[e.jsx("div",{className:"comm-name",children:r.name}),e.jsxs("div",{className:"comm-unit",children:["/",r.unit]}),e.jsxs("div",{className:"comm-price",children:["$",pe(r.price)]}),e.jsxs("div",{className:`comm-chg ${r.changePct>=0?"up":"down"}`,children:[r.changePct>=0?"+":"",r.changePct.toFixed(2),"%"]})]},r.id)),e.jsx("style",{children:`
        .comm-table {
          display: flex;
      ...
      `})]})}function xe(){const{lists:o,activeId:r,symbols:a,add:n,remove:h,createList:l,setActive:d}=T(),[N,x]=v.useState(!1),[y,m]=v.useState(""),[b,f]=v.useState(""),[k,s]=v.useState(!1),i=C({queries:a.map(t=>({queryKey:["quote",t],queryFn:()=>u.getQuote(t),staleTime:6e4,refetchInterval:6e4}))}),j=C({queries:a.map(t=>({queryKey:["history",t,30],queryFn:()=>u.getHistory(t,30),staleTime:5*6e4}))});function L(t){t.preventDefault();const c=y.trim().toUpperCase();c&&(n(c),m(""),x(!1))}function G(t){t.preventDefault();const c=b.trim();c&&(l(c),f(""),s(!1))}return e.jsxs("div",{className:"wl-panel",children:[o.length>1&&e.jsx("div",{className:"wl-tabs",children:o.map(t=>e.jsx("button",{className:`wl-tab ${t.id===r?"active":""}`,onClick:()=>d(t.id),title:t.name,children:t.name},t.id))}),e.jsxs("div",{className:"wl-list",children:[a.length===0&&e.jsx("div",{className:"wl-empty",children:"No symbols — add one below"}),a.map((t,c)=>{const g=i[c]?.data,P=j[c]?.data,z=(g?.changePct??0)>=0,F=P?.map(M=>M.close)??[];return e.jsxs("div",{className:"wl-row",children:[e.jsx(E,{size:10,className:"wl-star"}),e.jsxs("div",{className:"wl-sym-col",children:[e.jsx("span",{className:"wl-sym",children:t}),g?.exchange&&e.jsx("span",{className:"wl-exch",children:g.exchange})]}),F.length>=5&&e.jsx("div",{className:"wl-spark",children:e.jsx(X,{data:F,up:z,height:24,width:56})}),e.jsx("div",{className:"wl-price-col",children:g?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"wl-price",children:g.price.toFixed(2)}),e.jsxs("span",{className:`wl-chg ${z?"up":"down"}`,children:[z?"+":"",g.changePct.toFixed(2),"%"]})]}):e.jsx("span",{className:"wl-loading",children:"—"})}),e.jsx("button",{className:"wl-remove",onClick:()=>h(t),title:`Remove ${t}`,"aria-label":`Remove ${t}`,children:e.jsx(q,{size:10})})]},t)})]}),N?e.jsxs("form",{className:"wl-add-form",onSubmit:L,children:[e.jsx("input",{className:"wl-input",value:y,onChange:t=>m(t.target.value),placeholder:"e.g. SCOM.NR",autoFocus:!0}),e.jsx("button",{type:"submit",className:"wl-add-btn",children:"Add"}),e.jsx("button",{type:"button",className:"wl-cancel-btn",onClick:()=>x(!1),children:"✕"})]}):e.jsxs("div",{className:"wl-footer",children:[e.jsxs("button",{className:"wl-add-trigger",onClick:()=>x(!0),children:[e.jsx(A,{size:10})," Add symbol"]}),k?e.jsxs("form",{className:"wl-newlist-form",onSubmit:G,children:[e.jsx("input",{className:"wl-input",value:b,onChange:t=>f(t.target.value),placeholder:"List name",autoFocus:!0,style:{width:80}}),e.jsx("button",{type:"submit",className:"wl-add-btn",children:"OK"}),e.jsx("button",{type:"button",className:"wl-cancel-btn",onClick:()=>s(!1),children:"✕"})]}):e.jsxs("button",{className:"wl-list-trigger",onClick:()=>s(!0),title:"New watchlist",children:[e.jsx(A,{size:9})," List"]})]}),e.jsx("style",{children:`
      ...
      `})]}):null}function ve({active:o,payload:r}){if(!o||!r?.length)return null;const a=r[0]?.payload;return a?e.jsxs("div",{style:{background:"var(--color-bg-elevated)",border:"1px solid var(--color-border)",borderRadius:4,padding:"6px 10px",fontSize:11,fontFamily:"var(--font-mono)"},children:[e.jsx("div",{style:{color:"var(--color-text-muted)",marginBottom:2},children:a.label}),e.jsxs("div",{style:{color:"var(--color-gold)",fontWeight:700},children:[a.yield.toFixed(3),"%"]})]}):null}function we(){const{data:o,isLoading:r}=p({queryKey:["yield-curve"],queryFn:B,staleTime:36e5,refetchInterval:36e5});if(r)return e.jsx("div",{style:{height:120,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,color:"var(--color-text-muted)"},children:"Loading yield curve…"});if(!o?.length)return e.jsx("div",{style:{height:60,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,color:"var(--color-text-muted)",fontStyle:"italic"},children:"Yield curve data unavailable"});const a=Math.max(0,Math.min(...o.map(l=>l.yield))-.2),n=Math.max(...o.map(l=>l.yield))+.2,h=o.some((l,d)=>d>0&&l.yield<o[d-1].yield);return e.jsxs("div",{className:"yc-panel",children:[e.jsxs("div",{className:"yc-header",children:[e.jsx("span",{className:"yc-title",children:"US Yield Curve"}),h&&e.jsx("span",{className:"yc-inverted",children:"⚠ Inverted"}),e.jsx("div",{className:"yc-values",children:o.map(l=>e.jsxs("span",{className:"yc-tick",children:[e.jsx("span",{className:"yc-mat",children:l.maturity}),e.jsxs("span",{className:"yc-yield",children:[l.yield.toFixed(2),"%"]})]},l.maturity))})]}),e.jsx(_,{width:"100%",height:90,children:e.jsxs(J,{data:o,margin:{top:4,right:4,bottom:0,left:0},children:[e.jsx(Z,{strokeDasharray:"3 3",stroke:"var(--color-border-subtle)",vertical:!1}),e.jsx(H,{dataKey:"maturity",tick:{fontSize:9,fill:"var(--color-text-muted)",fontFamily:"var(--font-mono)"},tickLine:!1,axisLine:{stroke:"var(--color-border-subtle)"}}),e.jsx(V,{domain:[a,n],tick:{fontSize:9,fill:"var(--color-text-muted)",fontFamily:"var(--font-mono)"},tickLine:!1,axisLine:!1,width:32,orientation:"right",tickFormatter:l=>`${l.toFixed(1)}%`}),e.jsx(Q,{content:e.jsx(ve,{})}),e.jsx(ee,{type:"monotone",dataKey:"yield",stroke:h?"var(--color-down)":"var(--color-gold)",strokeWidth:2,dot:{fill:"var(--color-gold)",r:3},isAnimationActive:!1})]})}),e.jsx("style",{children:`
...
`;function je(){const o=D();return e.jsxs("div",{className:"amap-wrap",children:[e.jsxs("svg",{viewBox:"0 0 210 280",className:"amap-svg","aria-label":"African exchanges map",children:[e.jsx("path",{d:be,className:"amap-continent"}),ye.map(r=>e.jsxs("g",{className:"amap-pin-group",onClick:()=>o(`/exchange/${r.id}`),role:"button","aria-label":`${r.name} — ${r.country}`,tabIndex:0,onKeyDown:a=>a.key==="Enter"&&o(`/exchange/${r.id}`),children:[e.jsx("circle",{cx:r.x,cy:r.y,r:8,fill:r.color,opacity:.15,className:"amap-ring"}),e.jsx("circle",{cx:r.x,cy:r.y,r:4.5,fill:r.color,className:"amap-dot"}),e.jsx("text",{x:r.x,y:r.y-11,className:"amap-label",fill:r.color,textAnchor:"middle",fontSize:"7",fontFamily:"var(--font-mono)",fontWeight:"700",children:r.name})]},r.id))]}),e.jsx("style",{children:`
      ...
      `})]})}function Pe(){const[o,r]=v.useState(!0),{data:a,isLoading:n}=p({queryKey:["indices","all"],queryFn:()=>u.getIndices?.("all")??Promise.resolve([]),staleTime:6e4}),{data:h,isLoading:l}=p({queryKey:["forex","major"],queryFn:()=>K(),staleTime:6e4}),{data:d,isLoading:N}=p({queryKey:["news","dashboard"],queryFn:()=>u.getNews?.("africa")??Promise.resolve([]),staleTime:5*6e4}),{data:x,isLoading:y}=p({queryKey:["commodities"],queryFn:()=>u.getCommodities?.()??Promise.resolve([]),staleTime:6e4}),{data:m,isLoading:b}=p({queryKey:["movers","all"],queryFn:()=>u.getTopMovers?.("all")??Promise.resolve({gainers:[],losers:[]}),staleTime:6e4}),f=a?.filter(s=>s.changePct>=0).length??0,k=(a?.length??0)-f;return e.jsxs("div",{className:"dashboard",children:[e.jsx("div",{className:"dash-header",children:e.jsxs("div",{className:"dash-title-row",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"dash-title",children:"African Markets"}),e.jsx("p",{className:"dash-subtitle",children:new Intl.DateTimeFormat("en-ZA",{weekday:"long",year:"numeric",month:"long",day:"numeric"}).format(new Date)})]}),!n&&e.jsxs("div",{className:"dash-sentiment",children:[e.jsxs("span",{className:"sentiment-item up",children:[e.jsx(W,{size:13})," ",f," up"]}),e.jsxs("span",{className:"sentiment-item down",children:[e.jsx(oe,{size:13})," ",k," down"]})]}),e.jsx(U,{width:80,height:80,opacity:.08,style:{position:"absolute",right:0,top:0}})]})}),e.jsx(fe,{}),e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Indices"}),n?e.jsx(Ne,{count:5}):e.jsx("div",{className:"idx-strip",children:a?.map(s=>e.jsx($,{index:s},s.id))})]}),e.jsxs("div",{className:"dash-grid-3",children:[e.jsxs("div",{className:"dash-col",children:[e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Top Movers"}),b?e.jsx(w,{height:180}):(m?.gainers.length??0)+(m?.losers.length??0)>0?e.jsx(Y,{gainers:m?.gainers??[],losers:m?.losers??[]}):e.jsx(S,{message:"Movers data not available"})]}),e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Watchlist"}),e.jsx(xe,{})]}),e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Exchanges"}),e.jsx("div",{className:"panel",style:{padding:"0.5rem"},children:e.jsx(je,{})})]})]}),e.jsxs("div",{className:"dash-col",children:[e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Forex Rates"}),l?e.jsx(w,{height:180}):e.jsx(O,{rates:h??[]})]}),e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Commodities"}),y?e.jsx(w,{height:200}):(x?.length??0)>0?e.jsx(he,{items:x??[]}):e.jsx(S,{message:"Commodity data unavailable"})]}),e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Yield Curve"}),e.jsx("div",{className:"panel",style:{padding:"0.75rem"},children:e.jsx(we,{})})]})]}),e.jsx("div",{className:"dash-col",children:e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Latest News"}),N?e.jsx(w,{height:400}):(d?.length??0)>0?e.jsx(de,{items:d??[]}):e.jsx(S,{message:"Live news feed not yet connected"})]})})]}),e.jsxs("div",{className:"cheat-wrap panel",children:[e.jsxs("button",{className:"cheat-toggle",onClick:()=>r(s=>!s),children:[e.jsx("span",{className:"cheat-toggle-label",children:"Quick Reference — Keyboard Shortcuts & Features"}),o?e.jsx(se,{size:12}):e.jsx(ae,{size:12})]}),o&&e.jsxs("div",{className:"cheat-body",children:[e.jsxs("div",{className:"cheat-col",children:[e.jsx("div",{className:"cheat-section-title",children:"Navigation (G + key)"}),[["G D","Dashboard"],["G J","JSE Exchange"],["G U","USE Exchange"],["G N","NGX Exchange"],["G F","Forex rates"],["G W","Watchlist"],["G P","Portfolio"],["G A","Alerts"],["G S","Screener"],["G I","Macro indicators"],["G M","Monitor mode"],["?","Show all shortcuts"]].map(([s,i])=>e.jsxs("div",{className:"cheat-row",children:[e.jsx("kbd",{className:"cheat-key",children:s}),e.jsx("span",{className:"cheat-desc",children:i})]},s))]}),e.jsxs("div",{className:"cheat-col",children:[e.jsx("div",{className:"cheat-section-title",children:"Chart Indicators"}),[["MA20 / MA50","20 & 50-day moving averages"],["BB","Bollinger Bands (20-period)"],["VWAP","Volume-weighted average price"],["RSI","Relative Strength Index (14)"],["MACD","Momentum oscillator (12/26/9)"],["LR","Linear regression trendline"],["FIB","Fibonacci retracement levels"],["PAT","Candlestick pattern detection"],["1D~","Simulated intraday view"]].map(([s,i])=>e.jsxs("div",{className:"cheat-row",children:[e.jsx("kbd",{className:"cheat-key",children:s}),e.jsx("span",{className:"cheat-desc",children:i})]},s))]}),e.jsxs("div",{className:"cheat-col",children:[e.jsx("div",{className:"cheat-section-title",children:"Live Data Sources"}),[["✅","JSE stocks — Yahoo Finance (.JO)"],["✅","USE stocks — use.or.ug live feed"],["✅","Commodities — Yahoo futures (GC=F, CL=F…)"],["✅","Forex — open.er-api.com (9 pairs)"],["✅","Macro — World Bank Open Data"],["✅","News — Google News RSS"],["✅","Yield curve — Yahoo (^IRX, ^TNX…)"],["⚠","NGX / NSE / GSE — no free source yet"]].map(([s,i])=>e.jsxs("div",{className:"cheat-row cheat-row--data",children:[e.jsx("span",{className:"cheat-icon",children:s}),e.jsx("span",{className:"cheat-desc",children:i})]},i))]}),e.jsxs("div",{className:"cheat-col",children:[e.jsx("div",{className:"cheat-section-title",children:"Features"}),[["Screener","Filter & rank stocks across exchanges"],["Compare","Normalized chart + correlation matrix"],["Portfolio","P&L, allocation donut, risk metrics"],["Monitor","Full-screen watchlist grid"],["Alerts","Price & % change triggers"],["Yield Curve","US Treasuries inversion detection"],["Africa Map","Click exchanges on the map"],["Macro","World Bank GDP, CPI, unemployment"],["Export","CSV download on Exchange + Portfolio"]].map(([s,i])=>e.jsxs("div",{className:"cheat-row",children:[e.jsx("span",{className:"cheat-feat",children:s}),e.jsx("span",{className:"cheat-desc",children:i})]},s))]}),e.jsxs("div",{className:"cheat-eggs",children:[e.jsx("div",{className:"cheat-eggs-label",children:"🥚 Secret Codes"}),e.jsx("div",{className:"cheat-eggs-row",children:[{trigger:"↑↑↓↓←→←→BA",reveal:null,name:"Bloomberg Beast Mode",desc:"Konami code — activates a 30-day Bloomberg Terminal trial (fake)"},{trigger:"G O",reveal:null,name:"Oracle of Lagos",desc:"Summons the keeper of African market wisdom for a prophecy"},{trigger:"/jollof-war",reveal:null,name:"The Great Jollof War",desc:"Nigeria vs Ghana — the eternal rice debate, settled by markets"},{trigger:"G L",reveal:null,name:"SIMBA!",desc:"Also fires automatically when a stock hits its 52-week high"},{trigger:"[???]",reveal:"G Z",name:"What Would Dangote Do?",desc:"Wisdom from Africa's richest person, delivered with authority"},{trigger:"[???]",reveal:"G H",name:"Hakuna Matata",desc:"Also fires automatically when your portfolio is down more than 5%"},{trigger:"[???]",reveal:"G R",name:"Circle of Life",desc:"Also fires automatically when your portfolio hits a new all-time high"}].map(({trigger:s,reveal:i,name:j,desc:L})=>e.jsxs("div",{className:"cheat-egg-item",children:[e.jsxs("kbd",{className:"cheat-egg-key","data-reveal":i??void 0,style:i?{cursor:"help",position:"relative"}:void 0,children:[s,i&&e.jsx("span",{className:"cheat-egg-tooltip",children:i})]}),e.jsxs("div",{className:"cheat-egg-body",children:[e.jsx("span",{className:"cheat-egg-name",children:j}),e.jsx("span",{className:"cheat-egg-desc",children:L})]})]},j))})]})]})]}),e.jsx("style",{children:`
      ...
      `})]})}function S({message:o}){return e.jsx("div",{style:{padding:"1.25rem 0.75rem",fontSize:"11px",color:"var(--color-text-muted)",textAlign:"center",border:"1px dashed var(--color-border)",borderRadius:4},children:o})}function Ne({count:o}){return e.jsx("div",{style:{display:"flex",gap:"0.75rem"},children:Array.from({length:o}).map((r,a)=>e.jsx(w,{width:160,height:110},a))})}function w({width:o,height:r}){return e.jsx("div",{style:{width:o??"100%",height:r,background:"var(--color-bg-tertiary)",borderRadius:4,animation:"pulse 1.5s ease-in-out infinite"}})}export{Pe as default};
