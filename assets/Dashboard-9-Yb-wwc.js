import{j as e,r as v,k as C,e as h}from"./vendor-9MAh3nQh.js";import{c as I,u as G,p as u,S as P,X as q,g as R,a as B,T as W,b as O}from"./index-B6J8VvEo.js";import{N as K,I as U,T as J}from"./NdebelePanel-C_YHhQqb.js";import{F as $}from"./ForexTable-CuCchoPr.js";import{M as Y}from"./MediaPanel-Bm4IThD8.js";import{S as X}from"./Sparkline-Sa5-OsUq.js";import{P as E}from"./plus-DZXS6tpo.js";import{R as V,L as _,C as Z,X as H,Y as Q,T as ee,a as te}from"./recharts-WEknt4oI.js";import{T as ae}from"./trending-down-DiR6KCty.js";import"./store-DR-NtvzW.js";const re=[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]],oe=I("chevron-down",re);const se=[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]],ie=I("chevron-up",se),z=[{date:"01-13",year:1887,text:"The Johannesburg Stock Exchange opens, just one year after gold was discovered on the Witwatersrand. The first listings are mining companies. Nobody is surprised."},{date:"02-04",year:1994,text:"The JSE opens to foreign investors for the first time as South Africa transitions toward democracy. The rand strengthens. History is made."},{date:"03-19",year:1961,text:"The Nairobi Stock Exchange is formally constituted. Kenya becomes one of the first African nations with an organized securities market."},{date:"04-27",year:1994,text:"South Africa holds its first democratic election. The JSE surges. Nelson Mandela will become President. The market understands what this means."},{date:"05-07",year:2001,text:"MTN lists on the JSE. The South African telco will go on to become the most valuable brand on the African continent. Subscribers: 2 million. Today: 280 million."},{date:"06-12",year:1989,text:"The Ghana Stock Exchange is established. It will go on to be one of the best-performing exchanges in the world in 2023. Ghana knows what it is doing."},{date:"07-02",year:1960,text:"The Lagos Stock Exchange — later renamed the Nigerian Exchange Group — begins operations in a borrowed conference room with 19 securities listed."},{date:"08-14",year:2007,text:"The Dangote Group, founded on ₦500,000 borrowed from Aliko Dangote's uncle in 1977, announces it will list Dangote Cement. Cement. The empire begins."},{date:"09-15",year:2008,text:"Lehman Brothers collapses. African markets feel the shockwave — though the JSE, NSE, and NGX had less exposure to subprime mortgages than their Western counterparts. One small mercy."},{date:"10-31",year:2017,text:"Naspers, the South African media giant, announces it will spin off its global internet assets. Its 31% stake in Tencent is worth more than the JSE's entire banking sector. This is a normal thing that happened."},{date:"11-17",year:1997,text:"The Uganda Securities Exchange is founded. The exchange will eventually modernize to fully electronic trading — making it one of Africa's most technologically advanced small exchanges."},{date:"12-09",year:1994,text:"The Lusaka Stock Exchange opens in Zambia with 7 listed companies. The original trading floor consists of a small room and considerable optimism."},{date:"01-22",year:2019,text:"Zimbabwe's ZSE is temporarily suspended by the government amid hyperinflation. When it reopens, stocks are priced in Zimbabwe dollars. Then USD. The accountants are tired."},{date:"02-19",year:2020,text:"COVID-19 begins reaching African shores. The JSE falls 8% in a single day — its worst single-day drop since the 2008 crisis. The continent braces."},{date:"03-23",year:2020,text:"The JSE halts trading as circuit breakers trigger during the COVID-19 crash. Every exchange on the continent is red. Zamani would have shown a lot of red that day."},{date:"04-20",year:2020,text:"WTI crude oil futures go negative for the first time in history — traders literally paying people to take oil. Nigeria's budget is based on $57/barrel. The math does not work."},{date:"05-26",year:2022,text:"The Africa Continental Free Trade Agreement (AfCFTA) begins to show early signs of cross-border capital flows increasing. Pan-African investing becomes less theoretical."},{date:"06-22",year:1998,text:"The BRVM (Bourse Régionale des Valeurs Mobilières) opens, serving 8 West African nations. A single exchange for the entire UEMOA zone. Ambitious. Impressively functional."},{date:"07-28",year:2022,text:"Ghana's GSE Composite Index has its best year on record in 2022, rising over 40% — making it the world's best-performing stock exchange that year. Jollof rice and equity returns."},{date:"08-30",year:2011,text:"Africa's combined stock market capitalisation passes $1 trillion for the first time. The continent's markets have grown 500% in 10 years. The world starts paying attention."},{date:"09-03",year:1954,text:"The Nairobi Securities Exchange traces its roots to this period, when trading in shares first began in Kenya under the East African Stock Exchange Committee."},{date:"10-17",year:2023,text:"The JSE celebrates 136 years of operation — making it not just Africa's oldest and largest exchange, but one of the 20 largest in the world by market capitalisation."},{date:"11-09",year:2011,text:"Equity Bank Kenya lists on the Uganda Securities Exchange via a cross-listing — one of the first examples of true pan-African equity integration. The borders are getting thinner."},{date:"12-31",year:2023,text:"The JSE All Share Index closes the year up 8.2%. In a year where South Africa dealt with load-shedding, political uncertainty, and a 10%+ inflation peak, investors take the win."}];function ne(){const t=new Date,a=`${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`;return z.find(r=>r.date===a)??z[t.getDate()%z.length]}const le=["surge","jump","gain","rise","record","profit","growth","strong","beat","higher","boost","rally","soar","climb","outperform","upgrade","buy"],ce=["drop","fall","plunge","lose","decline","loss","weak","miss","lower","cut","recession","crash","sell-off","downgrade","warning","risk","concern"];function de(t){const a=t.toLowerCase();return le.some(r=>a.includes(r))?"pos":ce.some(r=>a.includes(r))?"neg":null}function me(t){const a=Date.now()-t,r=Math.floor(a/6e4);if(r<60)return`${r}m`;const l=Math.floor(r/60);return l<24?`${l}h`:`${Math.floor(l/24)}d`}function he({items:t}){return e.jsxs("div",{className:"panel news-feed",children:[t.map(a=>{const r=de(a.headline);return e.jsxs("a",{className:"news-item",href:a.url,target:"_blank",rel:"noopener",children:[e.jsxs("div",{className:"news-meta",children:[e.jsx("span",{className:"news-source",children:a.source}),a.exchange&&e.jsx("span",{className:"news-tag",children:a.exchange}),r==="pos"&&e.jsx("span",{className:"news-sent pos",children:"▲"}),r==="neg"&&e.jsx("span",{className:"news-sent neg",children:"▼"}),e.jsx("span",{className:"news-time",children:me(a.publishedAt)})]}),e.jsx("div",{className:"news-headline",children:a.headline})]},a.id)}),e.jsx("style",{children:`
      ...
      `})]})}const ge=new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function pe(t){return t>=1e3?new Intl.NumberFormat("en-US",{maximumFractionDigits:0}).format(t):ge.format(t)}function xe({items:t}){return e.jsxs("div",{className:"comm-table",children:[t.map(a=>e.jsxs("div",{className:"comm-row",children:[e.jsx("div",{className:"comm-name",children:a.name}),e.jsxs("div",{className:"comm-unit",children:["/",a.unit]}),e.jsxs("div",{className:"comm-price",children:["$",pe(a.price)]}),e.jsxs("div",{className:`comm-chg ${a.changePct>=0?"up":"down"}`,children:[a.changePct>=0?"+":"",a.changePct.toFixed(2),"%"]})]},a.id)),e.jsx("style",{children:`
        .comm-table {
          display: flex;
      ...
      `})]})}function ue(){const{lists:t,activeId:a,symbols:r,add:l,remove:g,createList:i,setActive:d}=G(),[N,p]=v.useState(!1),[w,m]=v.useState(""),[b,f]=v.useState(""),[k,s]=v.useState(!1),n=C({queries:r.map(o=>({queryKey:["quote",o],queryFn:()=>u.getQuote(o),staleTime:6e4,refetchInterval:6e4}))}),j=C({queries:r.map(o=>({queryKey:["history",o,30],queryFn:()=>u.getHistory(o,30),staleTime:5*6e4}))});function S(o){o.preventDefault();const c=w.trim().toUpperCase();c&&(l(c),m(""),p(!1))}function L(o){o.preventDefault();const c=b.trim();c&&(i(c),f(""),s(!1))}return e.jsxs("div",{className:"wl-panel",children:[t.length>1&&e.jsx("div",{className:"wl-tabs",children:t.map(o=>e.jsx("button",{className:`wl-tab ${o.id===a?"active":""}`,onClick:()=>d(o.id),title:o.name,children:o.name},o.id))}),e.jsxs("div",{className:"wl-list",children:[r.length===0&&e.jsx("div",{className:"wl-empty",children:"No symbols — add one below"}),r.map((o,c)=>{const x=n[c]?.data,M=j[c]?.data,T=(x?.changePct??0)>=0,F=M?.map(D=>D.close)??[];return e.jsxs("div",{className:"wl-row",children:[e.jsx(P,{size:10,className:"wl-star"}),e.jsxs("div",{className:"wl-sym-col",children:[e.jsx("span",{className:"wl-sym",children:o}),x?.exchange&&e.jsx("span",{className:"wl-exch",children:x.exchange})]}),F.length>=5&&e.jsx("div",{className:"wl-spark",children:e.jsx(X,{data:F,up:T,height:24,width:56})}),e.jsx("div",{className:"wl-price-col",children:x?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"wl-price",children:x.price.toFixed(2)}),e.jsxs("span",{className:`wl-chg ${T?"up":"down"}`,children:[T?"+":"",x.changePct.toFixed(2),"%"]})]}):e.jsx("span",{className:"wl-loading",children:"—"})}),e.jsx("button",{className:"wl-remove",onClick:()=>g(o),title:`Remove ${o}`,"aria-label":`Remove ${o}`,children:e.jsx(q,{size:10})})]},o)})]}),N?e.jsxs("form",{className:"wl-add-form",onSubmit:S,children:[e.jsx("input",{className:"wl-input",value:w,onChange:o=>m(o.target.value),placeholder:"e.g. SCOM.NR",autoFocus:!0}),e.jsx("button",{type:"submit",className:"wl-add-btn",children:"Add"}),e.jsx("button",{type:"button",className:"wl-cancel-btn",onClick:()=>p(!1),children:"✕"})]}):e.jsxs("div",{className:"wl-footer",children:[e.jsxs("button",{className:"wl-add-trigger",onClick:()=>p(!0),children:[e.jsx(E,{size:10})," Add symbol"]}),k?e.jsxs("form",{className:"wl-newlist-form",onSubmit:L,children:[e.jsx("input",{className:"wl-input",value:b,onChange:o=>f(o.target.value),placeholder:"List name",autoFocus:!0,style:{width:80}}),e.jsx("button",{type:"submit",className:"wl-add-btn",children:"OK"}),e.jsx("button",{type:"button",className:"wl-cancel-btn",onClick:()=>s(!1),children:"✕"})]}):e.jsxs("button",{className:"wl-list-trigger",onClick:()=>s(!0),title:"New watchlist",children:[e.jsx(E,{size:9})," List"]})]}),e.jsx("style",{children:`
      ...
      `})]})}function fe(t){return t.id==="us10y"?t.value.toFixed(2)+"%":t.id==="vix"||t.id==="dxy"?t.value.toFixed(2):t.value>=1e4?new Intl.NumberFormat("en-US",{maximumFractionDigits:0}).format(t.value):t.value>=1e3?new Intl.NumberFormat("en-US",{maximumFractionDigits:1}).format(t.value):t.value.toFixed(2)}function ve({m:t}){const a=t.id==="vix"?t.changePct<=0:t.changePct>=0,r=t.changePct>=0?"+":"";return e.jsxs("div",{className:"gm-item",children:[e.jsx("span",{className:"gm-name",children:t.name}),e.jsx("span",{className:"gm-value",children:fe(t)}),e.jsxs("span",{className:`gm-pct ${a?"up":"down"}`,children:[r,t.changePct.toFixed(2),"%"]})]})}function ye(){const{data:t}=h({queryKey:["global-markets"],queryFn:R,staleTime:6e4,refetchInterval:6e4});return t?.length?e.jsxs("div",{className:"gm-bar",children:[e.jsx("div",{className:"gm-label",children:"GLOBAL"}),e.jsx("div",{className:"gm-scroll",children:t.map(a=>e.jsx(ve,{m:a},a.id))}),e.jsx("style",{children:`
        .gm-bar {
          display: flex;
          align-items: stretch;
      ...
      `})]}):null}function we({active:t,payload:a}){if(!t||!a?.length)return null;const r=a[0]?.payload;return r?e.jsxs("div",{style:{background:"var(--color-bg-elevated)",border:"1px solid var(--color-border)",borderRadius:4,padding:"6px 10px",fontSize:11,fontFamily:"var(--font-mono)"},children:[e.jsx("div",{style:{color:"var(--color-text-muted)",marginBottom:2},children:r.label}),e.jsxs("div",{style:{color:"var(--color-gold)",fontWeight:700},children:[r.yield.toFixed(3),"%"]})]}):null}function be(){const{data:t,isLoading:a}=h({queryKey:["yield-curve"],queryFn:B,staleTime:36e5,refetchInterval:36e5});if(a)return e.jsx("div",{style:{height:120,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,color:"var(--color-text-muted)"},children:"Loading yield curve…"});if(!t?.length)return e.jsx("div",{style:{height:60,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,color:"var(--color-text-muted)",fontStyle:"italic"},children:"Yield curve data unavailable"});const r=Math.max(0,Math.min(...t.map(i=>i.yield))-.2),l=Math.max(...t.map(i=>i.yield))+.2,g=t.some((i,d)=>d>0&&i.yield<t[d-1].yield);return e.jsxs("div",{className:"yc-panel",children:[e.jsxs("div",{className:"yc-header",children:[e.jsx("span",{className:"yc-title",children:"US Yield Curve"}),g&&e.jsx("span",{className:"yc-inverted",children:"⚠ Inverted"}),e.jsx("div",{className:"yc-values",children:t.map(i=>e.jsxs("span",{className:"yc-tick",children:[e.jsx("span",{className:"yc-mat",children:i.maturity}),e.jsxs("span",{className:"yc-yield",children:[i.yield.toFixed(2),"%"]})]},i.maturity))})]}),e.jsx(V,{width:"100%",height:90,children:e.jsxs(_,{data:t,margin:{top:4,right:4,bottom:0,left:0},children:[e.jsx(Z,{strokeDasharray:"3 3",stroke:"var(--color-border-subtle)",vertical:!1}),e.jsx(H,{dataKey:"maturity",tick:{fontSize:9,fill:"var(--color-text-muted)",fontFamily:"var(--font-mono)"},tickLine:!1,axisLine:{stroke:"var(--color-border-subtle)"}}),e.jsx(Q,{domain:[r,l],tick:{fontSize:9,fill:"var(--color-text-muted)",fontFamily:"var(--font-mono)"},tickLine:!1,axisLine:!1,width:32,orientation:"right",tickFormatter:i=>`${i.toFixed(1)}%`}),e.jsx(ee,{content:e.jsx(we,{})}),e.jsx(te,{type:"monotone",dataKey:"yield",stroke:g?"var(--color-down)":"var(--color-gold)",strokeWidth:2,dot:{fill:"var(--color-gold)",r:3},isAnimationActive:!1})]})}),e.jsx("style",{children:`
      ...
      `})]})}function je(){const t=ne();return t?e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"On This Day in African Markets"}),e.jsxs("div",{className:"panel otd-panel",children:[e.jsx("div",{className:"otd-year",children:t.year}),e.jsx("p",{className:"otd-text",children:t.text})]})]}):null}function A({message:t}){return e.jsx("div",{style:{padding:"1.25rem 0.75rem",fontSize:"11px",color:"var(--color-text-muted)",textAlign:"center",border:"1px dashed var(--color-border)",borderRadius:4},children:t})}function Ne({count:t}){return e.jsx("div",{style:{display:"flex",gap:"0.75rem"},children:Array.from({length:t}).map((a,r)=>e.jsx(y,{width:160,height:110},r))})}function y({width:t,height:a}){return e.jsx("div",{style:{width:t??"100%",height:a,background:"var(--color-bg-tertiary)",borderRadius:4,animation:"pulse 1.5s ease-in-out infinite"}})}export{Me as default};
