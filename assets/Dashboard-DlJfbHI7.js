import{j as e,r as f,k as v,e as d}from"./vendor-9MAh3nQh.js";import{u as w,p as c,S as b,X as j,T as y,g as N}from"./index-DEfEmAlZ.js";import{N as z,I as F,T as k}from"./NdebelePanel-C_YHhQqb.js";import{F as P}from"./ForexTable-CuCchoPr.js";import{P as T}from"./plus-BQNZwQ1q.js";import{T as q}from"./trending-down-C162F5xu.js";import"./store-Dxzhro6a.js";import"./Sparkline-Sa5-OsUq.js";function C(r){const o=Date.now()-r,a=Math.floor(o/6e4);if(a<60)return`${a}m`;const t=Math.floor(a/60);return t<24?`${t}h`:`${Math.floor(t/24)}d`}function I({items:r}){return e.jsxs("div",{className:"panel news-feed",children:[r.map(o=>e.jsxs("a",{className:"news-item",href:o.url,target:"_blank",rel:"noopener",children:[e.jsxs("div",{className:"news-meta",children:[e.jsx("span",{className:"news-source",children:o.source}),o.exchange&&e.jsx("span",{className:"news-tag",children:o.exchange}),e.jsx("span",{className:"news-time",children:C(o.publishedAt)})]}),e.jsx("div",{className:"news-headline",children:o.headline})]},o.id)),e.jsx("style",{children:`
      ...
      `})]})}const S=new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function A(r){return r>=1e3?new Intl.NumberFormat("en-US",{maximumFractionDigits:0}).format(r):S.format(r)}function D({items:r}){return e.jsxs("div",{className:"comm-table",children:[r.map(o=>e.jsxs("div",{className:"comm-row",children:[e.jsx("div",{className:"comm-name",children:o.name}),e.jsxs("div",{className:"comm-unit",children:["/",o.unit]}),e.jsxs("div",{className:"comm-price",children:["$",A(o.price)]}),e.jsxs("div",{className:`comm-chg ${o.changePct>=0?"up":"down"}`,children:[o.changePct>=0?"+":"",o.changePct.toFixed(2),"%"]})]},o.id)),e.jsx("style",{children:`
        .comm-table {
          display: flex;
      ...
      `})]})}function O(){const{data:r,isLoading:o}=d({queryKey:["indices","all"],queryFn:()=>c.getIndices?.("all")??Promise.resolve([]),staleTime:6e4}),{data:a,isLoading:t}=d({queryKey:["forex","major"],queryFn:()=>N(),staleTime:6e4}),{data:x,isLoading:p}=d({queryKey:["news","dashboard"],queryFn:()=>c.getNews?.("africa")??Promise.resolve([]),staleTime:5*6e4}),{data:g,isLoading:u}=d({queryKey:["commodities"],queryFn:()=>c.getCommodities?.()??Promise.resolve([]),staleTime:6e4}),{data:h,isLoading:s}=d({queryKey:["movers","all"],queryFn:()=>c.getTopMovers?.("all")??Promise.resolve({gainers:[],losers:[]}),staleTime:6e4}),i=r?.filter(n=>n.changePct>=0).length??0,l=(r?.length??0)-i;return e.jsxs("div",{className:"dashboard",children:[e.jsx("div",{className:"dash-header",children:e.jsxs("div",{className:"dash-title-row",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"dash-title",children:"African Markets"}),e.jsx("p",{className:"dash-subtitle",children:new Intl.DateTimeFormat("en-ZA",{weekday:"long",year:"numeric",month:"long",day:"numeric"}).format(new Date)})]}),!o&&e.jsxs("div",{className:"dash-sentiment",children:[e.jsxs("span",{className:"sentiment-item up",children:[e.jsx(y,{size:13})," ",i," up"]}),e.jsxs("span",{className:"sentiment-item down",children:[e.jsx(q,{size:13})," ",l," down"]})]}),e.jsx(z,{width:80,height:80,opacity:.08,style:{position:"absolute",right:0,top:0}})]})}),e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Indices"}),o?e.jsx($,{count:5}):e.jsx("div",{className:"idx-strip",children:r?.map(n=>e.jsx(F,{index:n},n.id))})]}),e.jsxs("div",{className:"dash-grid-3",children:[e.jsxs("div",{className:"dash-col",children:[e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Top Movers"}),s?e.jsx(m,{height:180}):e.jsx(k,{gainers:h?.gainers??[],losers:h?.losers??[]})]}),e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Watchlist"}),e.jsx(M,{})]})]}),e.jsxs("div",{className:"dash-col",children:[e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Forex Rates"}),t?e.jsx(m,{height:180}):e.jsx(P,{rates:a??[]})]}),e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Commodities"}),u?e.jsx(m,{height:200}):e.jsx(D,{items:g??[]})]})]}),e.jsx("div",{className:"dash-col",children:e.jsxs("section",{className:"dash-section",children:[e.jsx("div",{className:"section-label",children:"Latest News"}),p?e.jsx(m,{height:400}):e.jsx(I,{items:x??[]})]})})]}),e.jsx("style",{children:`
