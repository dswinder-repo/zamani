import{r as x,e as g,j as e}from"./vendor-9MAh3nQh.js";import{p as b}from"./index-CF7uYZ8u.js";import{F as y}from"./ForexTable-CuCchoPr.js";import{R as j,A as S,a as w,X as N,Y as D,T as U,b as F}from"./recharts-Bc8jWMle.js";import"./store-Dxzhro6a.js";const k={USDZAR:"US Dollar / South African Rand",USDNGN:"US Dollar / Nigerian Naira",USDKES:"US Dollar / Kenyan Shilling",USDGHS:"US Dollar / Ghanaian Cedi",USDEGP:"US Dollar / Egyptian Pound",USDETB:"US Dollar / Ethiopian Birr",USDXOF:"US Dollar / West African CFA",ZARUSD:"South African Rand / US Dollar"};function h(l){return`${l.base}${l.quote}`}function z({active:l,payload:a}){if(!l||!a?.length)return null;const n=a[0]?.payload;return e.jsxs("div",{style:{background:"var(--color-bg-elevated)",border:"1px solid var(--color-border)",borderRadius:4,padding:"0.375rem 0.625rem",fontSize:11,fontFamily:"var(--font-mono)"},children:[e.jsx("div",{style:{color:"var(--color-text-muted)",marginBottom:2},children:n?.date}),e.jsx("div",{style:{color:"var(--color-text-primary)",fontWeight:700},children:Number(a[0].value).toFixed(4)})]})}function A({rates:l}){const a=x.useMemo(()=>{const r={USD:1};for(const i of l)i.base==="USD"&&(r[i.quote]=i.rate),i.quote==="USD"&&(r[i.base]=1/i.rate);return r},[l]),n=x.useMemo(()=>["USD",...Object.keys(a).filter(r=>r!=="USD").sort()],[a]),[m,s]=x.useState("1"),[c,f]=x.useState("USD"),[t,d]=x.useState("ZAR"),p=x.useMemo(()=>{const r=parseFloat(m);if(!isFinite(r)||!a[c]||!a[t])return null;const i=a[c],u=a[t],v=c==="USD"?r:r/i;return t==="USD"?v:v*u},[m,c,t,a]),o=()=>{f(t),d(c)};return e.jsxs("div",{className:"panel conv-card",children:[e.jsx("div",{className:"section-label",children:"Currency Converter"}),e.jsxs("div",{className:"conv-row",children:[e.jsx("input",{type:"number",className:"conv-amount",value:m,min:"0",step:"any",onChange:r=>s(r.target.value)}),e.jsx("select",{className:"conv-select",value:c,onChange:r=>f(r.target.value),children:n.map(r=>e.jsx("option",{children:r},r))}),e.jsx("button",{className:"conv-swap",onClick:o,title:"Swap currencies",children:"⇄"}),e.jsx("select",{className:"conv-select",value:t,onChange:r=>d(r.target.value),children:n.map(r=>e.jsx("option",{children:r},r))})]}),e.jsx("div",{className:"conv-result",children:p!=null?e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"conv-from num",children:[parseFloat(m||"0").toLocaleString("en-US",{minimumFractionDigits:2})," ",c]}),e.jsx("span",{className:"conv-eq",children:" = "}),e.jsxs("span",{className:"conv-to num",children:[p.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:4})," ",t]})]}):e.jsx("span",{style:{color:"var(--color-text-muted)",fontSize:12},children:"Rate not available"})})]})}function T(){const[l,a]=x.useState(null),{data:n,isLoading:m}=g({queryKey:["forex","all"],queryFn:()=>b.getForex?.([])??Promise.resolve([]),staleTime:6e4,refetchInterval:6e4}),s=l??(n?.[0]?h(n[0]):null),{data:c,isLoading:f}=g({queryKey:["forex-history",s],queryFn:()=>s?b.getHistory(s,30):Promise.resolve([]),staleTime:5*6e4,enabled:!!s}),t=n?.find(o=>h(o)===s),d=(t?.changePct??0)>=0,p=(c??[]).map(o=>({date:new Date(o.time).toLocaleDateString("en-US",{month:"short",day:"numeric"}),close:o.close}));return e.jsxs("div",{className:"forex-page",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"fx-h1",children:"Forex"}),e.jsx("p",{className:"fx-sub",children:"African currency exchange rates vs USD — live, refreshed every minute"})]}),e.jsxs("div",{className:"fx-body",children:[e.jsxs("div",{children:[e.jsx("div",{className:"section-label",children:"Rates"}),m?e.jsx("p",{style:{fontSize:12,color:"var(--color-text-muted)"},children:"Loading…"}):e.jsx("div",{className:"fx-rate-list panel",children:(n??[]).map(o=>{const r=h(o),i=r===s,u=o.changePct>=0;return e.jsxs("button",{className:`fx-rate-row ${i?"active":""}`,onClick:()=>a(r),children:[e.jsxs("span",{className:"fx-pair num",children:[o.base,"/",o.quote]}),e.jsx("span",{className:"fx-rate num",children:o.rate.toLocaleString("en-US",{minimumFractionDigits:4,maximumFractionDigits:4})}),e.jsxs("span",{className:`fx-chg num ${u?"text-up":"text-down"}`,children:[u?"+":"",o.changePct.toFixed(2),"%"]})]},r)})})]}),e.jsxs("div",{children:[e.jsx("div",{className:"section-label",children:s?k[s]??s:"Select a pair"}),e.jsxs("div",{className:"fx-chart-card panel",children:[t&&e.jsxs("div",{className:"fx-chart-header",children:[e.jsxs("span",{className:"fx-chart-pair num",children:[t.base,"/",t.quote]}),e.jsx("span",{className:"fx-chart-rate num",children:t.rate.toLocaleString("en-US",{minimumFractionDigits:4,maximumFractionDigits:4})}),e.jsxs("span",{className:`fx-chart-chg num ${d?"text-up":"text-down"}`,children:[d?"+":"",t.changePct.toFixed(2),"%"]})]}),f?e.jsx("div",{className:"fx-chart-loading",children:"Loading chart…"}):p.length>0?e.jsx(j,{width:"100%",height:200,children:e.jsxs(S,{data:p,margin:{top:8,right:4,bottom:0,left:0},children:[e.jsx("defs",{children:e.jsxs("linearGradient",{id:"fxGrad",x1:"0",y1:"0",x2:"0",y2:"1",children:[e.jsx("stop",{offset:"5%",stopColor:d?"var(--color-up)":"var(--color-down)",stopOpacity:.2}),e.jsx("stop",{offset:"95%",stopColor:d?"var(--color-up)":"var(--color-down)",stopOpacity:0})]})}),e.jsx(w,{strokeDasharray:"3 3",stroke:"var(--color-border-subtle)",vertical:!1}),e.jsx(N,{dataKey:"date",tick:{fontSize:10,fill:"var(--color-text-muted)",fontFamily:"var(--font-mono)"},tickLine:!1,axisLine:{stroke:"var(--color-border-subtle)"},interval:"preserveStartEnd"}),e.jsx(D,{domain:["auto","auto"],tick:{fontSize:10,fill:"var(--color-text-muted)",fontFamily:"var(--font-mono)"},tickLine:!1,axisLine:!1,width:52,orientation:"right",tickFormatter:o=>Number(o).toFixed(2)}),e.jsx(U,{content:e.jsx(z,{})}),e.jsx(F,{type:"monotone",dataKey:"close",stroke:d?"var(--color-up)":"var(--color-down)",strokeWidth:1.5,fill:"url(#fxGrad)",dot:!1,isAnimationActive:!1})]})}):e.jsx("div",{className:"fx-chart-loading",children:"No history data"})]}),e.jsxs("div",{style:{marginTop:"1.5rem"},children:[e.jsx("div",{className:"section-label",children:"All Rates"}),e.jsx(y,{rates:n??[]})]})]})]}),(n??[]).length>0&&e.jsx(A,{rates:n??[]}),e.jsx("style",{children:`
