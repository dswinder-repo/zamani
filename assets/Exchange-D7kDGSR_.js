import{r as p,j as e,L as P,l as R,e as v}from"./vendor-9MAh3nQh.js";import{c as A,a as O,b as F,d as z,E as G,X as H,Y as D,p as C}from"./index-D9GMaH-O.js";import{N as $,I as K,T as V}from"./NdebelePanel-C_YHhQqb.js";import{c as X}from"./store-Dxzhro6a.js";import"./Sparkline-Sa5-OsUq.js";const Z=[["path",{d:"M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z",key:"oz39mx"}],["path",{d:"m9 10 2 2 4-4",key:"1gnqz4"}]],_=A("bookmark-check",Z);const W=[["path",{d:"M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z",key:"oz39mx"}]],Q=A("bookmark",W),Y="https://use.or.ug/api/delayed-data",J={"AIRTEL UGANDA":"Airtel Uganda",BATU:"BAT Uganda",BOBU:"Bank of Baroda Uganda",CENT:"Centum Investment",DFCU:"dfcu Limited",EABL:"East African Breweries",EBL:"Equity Bank Uganda",JHL:"Jubilee Holdings",KA:"Kenya Airways",KCB:"KCB Group",MTNU:"MTN Uganda",NIC:"National Insurance Corp",NMG:"Nation Media Group",NVL:"New Vision Group",QCIL:"Quality Chemical Industries",SBU:"Stanbic Uganda Holdings",UCL:"Uganda Clays",UMEM:"Umeme Limited"},q={"AIRTEL UGANDA":222,BATU:820,BOBU:395,CENT:380,DFCU:790,EABL:1600,EBL:380,JHL:420,KA:6,KCB:420,MTNU:185,NIC:16,NMG:180,NVL:58,QCIL:7800,SBU:540,UCL:30,UMEM:265};async function S(){const n=await fetch(Y,{mode:"cors"});if(!n.ok)throw new Error(`USE API ${n.status}`);return n.json()}const I="zamani_use_prev";function E(){try{return JSON.parse(localStorage.getItem(I)??"{}")}catch{return{}}}function ee(n){try{localStorage.setItem(I,JSON.stringify(n))}catch{}}function ne(){return Object.entries(q).map(([n,s])=>({type:"EQUITY",stock:n,price:s,market_cap:0,volume:0,deals:0}))}async function k(){let n;try{n=await S()}catch(r){console.warn("[USE] API unreachable — using fallback prices:",r),n=ne()}const s=E(),l=n.filter(r=>r.type==="EQUITY"),a={};for(const r of l)a[r.stock]=r.price;return ee(a),l.map(r=>{const d=r.price,o=s[r.stock]??d,i=+(d-o).toFixed(2),c=o?+(i/o*100).toFixed(2):0;return{symbol:r.stock,name:J[r.stock]??r.stock,price:d,change:i,changePct:c,volume:r.volume,currency:"UGX",exchange:"USE",timestamp:Date.now()}})}async function se(){let n;try{n=await S()}catch{n=[]}const s=n.filter(a=>a.type==="INDEX"),l=E();return s.length?s.map(a=>{const r=a.price,d=l[a.stock]??r,o=+(r-d).toFixed(2),i=d?+(o/d*100).toFixed(2):0;return{id:`use-${a.stock.toLowerCase().replace(/\s+/g,"-")}`,name:a.stock==="LCI"?"USE Local Company Index":`USE ${a.stock}`,exchange:"USE",value:r,change:o,changePct:i,currency:"UGX",sparkline:[],timestamp:Date.now()}}):[{id:"use-lci",name:"USE LCI",exchange:"USE",value:0,change:0,changePct:0,currency:"UGX",sparkline:[],timestamp:Date.now()}]}async function re(){const s=[...await k()].sort((r,d)=>d.changePct-r.changePct),l=s.filter(r=>r.changePct>0).slice(0,5).map(r=>({symbol:r.symbol,name:r.name,exchange:"USE",price:r.price,changePct:r.changePct})),a=s.filter(r=>r.changePct<0).slice(-5).reverse().map(r=>({symbol:r.symbol,name:r.name,exchange:"USE",price:r.price,changePct:r.changePct}));return{gainers:l,losers:a}}function ae(n){const s=p.useRef(n),[l,a]=p.useState("");return p.useEffect(()=>{if(s.current===n)return;a(n>s.current?"flash-up":"flash-down"),s.current=n;const r=setTimeout(()=>a(""),800);return()=>clearTimeout(r)},[n]),l}function te({pct:n}){const s=n>=0;return e.jsxs("span",{className:`num stock-chg ${s?"text-up":"text-down"}`,style:{display:"inline-block",minWidth:52,textAlign:"right",padding:"1px 5px",borderRadius:3,background:s?"var(--color-up-subtle)":"var(--color-down-subtle)"},children:[s?"+":"",n.toFixed(2),"%"]})}function oe({q:n,exchangeId:s}){const l=ae(n.price);return e.jsxs(P,{to:`/exchange/${s}/stock/${encodeURIComponent(n.symbol)}`,className:`st-row ${l}`,children:[e.jsx("span",{className:"st-symbol num",children:n.symbol.replace(`.${s.toUpperCase()}`,"")}),e.jsx("span",{className:"st-name",children:n.name}),e.jsxs("span",{className:"st-price num st-align-r",children:[n.price.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}),e.jsx("span",{style:{fontSize:9,color:"var(--color-text-muted)",marginLeft:3},children:n.currency})]}),e.jsx("span",{className:"st-align-r",children:e.jsx(te,{pct:n.changePct})}),e.jsx("span",{className:"st-vol num st-align-r",children:n.volume?(n.volume/1e3).toFixed(0)+"K":"—"})]})}function ie({exchangeId:n,quotes:s,isLoading:l,activeSector:a}){const[r,d]=p.useState(""),o=p.useMemo(()=>s.filter(c=>!r||c.symbol.toLowerCase().includes(r.toLowerCase())||c.name.toLowerCase().includes(r.toLowerCase())),[s,r]),i=o.length;return e.jsxs("div",{className:"stocks-table-wrap panel",children:[e.jsxs("div",{className:"st-search-row",children:[e.jsx(O,{size:12}),e.jsx("input",{className:"st-search",placeholder:"Search symbols or names…",value:r,onChange:c=>d(c.target.value)}),e.jsxs("span",{className:"st-count",children:[i," ",a?`(${a})`:"securities"]})]}),e.jsxs("div",{className:"st-header",children:[e.jsx("span",{children:"Symbol"}),e.jsx("span",{children:"Name"}),e.jsx("span",{className:"st-align-r",children:"Price"}),e.jsx("span",{className:"st-align-r",children:"Change"}),e.jsx("span",{className:"st-align-r",children:"Volume"})]}),l?e.jsx("div",{className:"st-empty",children:"Loading…"}):o.length===0?e.jsx("div",{className:"st-empty",children:r?`No results for "${r}"`:"No securities in this sector"}):o.map(c=>e.jsx(oe,{q:c,exchangeId:n},c.symbol)),e.jsx("style",{children:`
      ...
      `})]})}const de=X()(F(n=>({presets:[],savePreset(s){const l={...s,id:`${Date.now()}-${Math.random().toString(36).slice(2)}`,createdAt:Date.now()};n(a=>({presets:[...a.presets,l]}))},deletePreset(s){n(l=>({presets:l.presets.filter(a=>a.id!==s)}))}}),{name:"zamani-screener-presets"})),ge={jse:{name:"Johannesburg Stock Exchange",country:"South Africa",flag:"🇿🇦",currency:"ZAR",accentVar:"--color-jse",founded:"1887",mic:"XJSE"},ngx:{name:"Nigerian Exchange Group",country:"Nigeria",flag:"🇳🇬",currency:"NGN",accentVar:"--color-ngx",founded:"1960",mic:"XLAG"},nse:{name:"Nairobi Securities Exchange",country:"Kenya",flag:"🇰🇪",currency:"KES",accentVar:"--color-nse",founded:"1954",mic:"XNAI"},gse:{name:"Ghana Stock Exchange",country:"Ghana",flag:"🇬🇭",currency:"GHS",accentVar:"--color-gse",founded:"1989",mic:"XGHA"},brvm:{name:"Bourse Régionale UEMOA",country:"West Africa",flag:"🇨🇮",currency:"XOF",accentVar:"--color-brvm",founded:"1998",mic:"XBRV"},zse:{name:"Zimbabwe Stock Exchange",country:"Zimbabwe",flag:"🇿🇼",currency:"USD",accentVar:"--color-zse",founded:"1896",mic:"XZIM"},bse:{name:"Botswana Stock Exchange",country:"Botswana",flag:"🇧🇼",currency:"BWP",accentVar:"--color-bse",founded:"1989",mic:"XBOT"},luse:{name:"Lusaka Securities Exchange",country:"Zambia",flag:"🇿🇲",currency:"ZMW",accentVar:"--color-luse",founded:"1994",mic:"XLUS"},use:{name:"Uganda Securities Exchange",country:"Uganda",flag:"🇺🇬",currency:"UGX",accentVar:"--color-use",founded:"1997",mic:"XUGA"}};function fe(){const{id:n=""}=R(),s=ge[n],l=z(n),[a,r]=p.useState(null),{presets:d,savePreset:o,deletePreset:i}=de(),c=d.filter(t=>t.exchange===n),g=n==="use",m=D.includes(n),{data:b,isLoading:f}=v({queryKey:["indices",n],queryFn:g?()=>se():()=>C.getIndices?.(n)??Promise.resolve([]),staleTime:6e4,refetchInterval:6e4}),{data:h,isLoading:T}=v({queryKey:["movers",n],queryFn:g?()=>re():()=>C.getTopMovers?.(n)??Promise.resolve({gainers:[],losers:[]}),staleTime:6e4,refetchInterval:6e4}),{data:u,isLoading:L}=v({queryKey:["stocks",n],queryFn:g?()=>k():()=>C.getExchangeStocks?.(n)??Promise.resolve([]),staleTime:6e4,refetchInterval:6e4}),B=p.useMemo(()=>{if(!u?.length)return[];const t=new Set(u.map(x=>y(n,x.symbol)));return j.filter(x=>t.has(x))},[u,n]),M=p.useMemo(()=>!a||!u?u??[]:u.filter(t=>y(n,t.symbol)===a),[u,a,n]);if(!s)return e.jsx("div",{style:{padding:"2rem",color:"var(--color-text-muted)"},children:"Exchange not found."});const N=(b??[]).filter(t=>t.exchange.toLowerCase()===n),U={"--color-gold":`var(${s.accentVar})`,"--color-gold-dim":`color-mix(in srgb, var(${s.accentVar}) 55%, #000)`,"--color-gold-bright":`color-mix(in srgb, var(${s.accentVar}) 140%, #fff)`,"--color-gold-subtle":`color-mix(in srgb, var(${s.accentVar}) 10%, transparent)`};function w(){if(!a)return;const t=`${n.toUpperCase()} — ${a}`;o({name:t,exchange:n,sectors:[a]})}return e.jsxs("div",{className:"exchange-page",style:U,children:[e.jsxs("div",{className:"ex-header panel",style:{borderLeftColor:`var(${s.accentVar})`},children:[e.jsxs("div",{className:"ex-header-left",children:[e.jsx("span",{className:"ex-flag",children:s.flag}),e.jsxs("div",{children:[e.jsxs("div",{className:"ex-title-row",children:[e.jsx("h1",{className:"ex-name",children:s.name}),e.jsx(G,{id:n})]}),e.jsxs("p",{className:"ex-meta",children:[s.country,s.mic&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"ex-sep",children:"·"}),e.jsx("span",{children:s.mic})]}),s.founded&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"ex-sep",children:"·"}),e.jsxs("span",{children:["Est. ",s.founded]})]}),e.jsx("span",{className:"ex-sep",children:"·"}),e.jsxs("span",{className:"num",children:[l," local"]})]})]})]}),e.jsx($,{width:80,height:80,color:`var(${s.accentVar})`,opacity:.08,style:{position:"absolute",right:0,top:0}})]}),e.jsxs("section",{children:[e.jsx("div",{className:"section-label",children:"Indices"}),f?e.jsx("p",{className:"ex-loading",children:"Loading…"}):N.length>0?e.jsx("div",{className:"idx-strip",children:N.map(t=>e.jsx(K,{index:t},t.id))}):e.jsx("p",{className:"ex-loading",children:m?`No index data available for ${s.name}.`:"Live index data for this exchange is not yet connected."})]}),m&&(u??[]).length>0&&e.jsx("section",{children:e.jsx(le,{exchangeId:n,quotes:u??[],activeSector:a,onSectorClick:r})}),m&&B.length>0&&e.jsxs("div",{className:"ex-sector-filters",children:[e.jsx("button",{className:`ex-sector-btn ${a?"":"active"}`,onClick:()=>r(null),children:"All"}),B.map(t=>e.jsx("button",{className:`ex-sector-btn ${a===t?"active":""}`,onClick:()=>r(x=>x===t?null:t),children:t},t)),a&&e.jsxs("button",{className:"ex-save-preset-btn",onClick:w,title:`Save "${a}" filter as preset`,children:[e.jsx(Q,{size:11})," Save filter"]}),c.length>0&&e.jsx("div",{className:"ex-presets",children:c.map(t=>e.jsxs("span",{className:`ex-preset-chip ${a===t.sectors[0]?"active":""}`,onClick:()=>r(x=>x===t.sectors[0]?null:t.sectors[0]),children:[e.jsx(_,{size:9}),t.name.split("—")[1]?.trim()??t.name,e.jsx("button",{className:"ex-preset-del",onClick:x=>{x.stopPropagation(),i(t.id)},"aria-label":"Remove preset",children:e.jsx(H,{size:8})})]},t.id))})]}),m?e.jsxs("div",{className:"ex-cols",children:[e.jsxs("section",{children:[e.jsx("div",{className:"section-label",children:"Top Movers"}),T?e.jsx("p",{className:"ex-loading",children:"Loading…"}):e.jsx(V,{gainers:h?.gainers??[],losers:h?.losers??[]})]}),e.jsxs("section",{className:"ex-stocks-col",children:[e.jsx("div",{className:"section-label",children:a?`${a} Securities`:"All Securities"}),e.jsx(ie,{exchangeId:n,quotes:M,isLoading:L,activeSector:a})]})]}):e.jsx(me,{name:s.name,accentVar:s.accentVar}),e.jsx("style",{children:`
