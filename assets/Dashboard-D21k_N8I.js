import{j as e,r as v,k as F,e as x,u as T}from"./vendor-9MAh3nQh.js";import{c as A,u as E,p as u,S as D,X as q,g as R,a as B,T as K,b as U}from"./index-CQBhi5-X.js";import{N as $,I as Y,T as W}from"./NdebelePanel-C_YHhQqb.js";import{F as O}from"./ForexTable-CuCchoPr.js";import{S as _}from"./Sparkline-Sa5-OsUq.js";import{P as C}from"./plus-CCwzQyYO.js";import{R as X,L as J,C as V,X as Z,Y as Q,T as H,a as ee}from"./recharts-DK6PfPlO.js";import{T as re}from"./trending-down-R0KpvU6E.js";import"./store-DR-NtvzW.js";const oe=[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]],ae=A("chevron-down",oe);const te=[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]],se=A("chevron-up",te),le=["surge","jump","gain","rise","record","profit","growth","strong","beat","higher","boost","rally","soar","climb","outperform","upgrade","buy"],ie=["drop","fall","plunge","lose","decline","loss","weak","miss","lower","cut","recession","crash","sell-off","downgrade","warning","risk","concern"];function ne(r){const o=r.toLowerCase();return le.some(a=>o.includes(a))?"pos":ie.some(a=>o.includes(a))?"neg":null}function ce(r){const o=Date.now()-r,a=Math.floor(o/6e4);if(a<60)return`${a}m`;const n=Math.floor(a/60);return n<24?`${n}h`:`${Math.floor(n/24)}d`}function de({items:r}){return e.jsxs("div",{className:"panel news-feed",children:[r.map(o=>{const a=ne(o.headline);return e.jsxs("a",{className:"news-item",href:o.url,target:"_blank",rel:"noopener",children:[e.jsxs("div",{className:"news-meta",children:[e.jsx("span",{className:"news-source",children:o.source}),o.exchange&&e.jsx("span",{className:"news-tag",children:o.exchange}),a==="pos"&&e.jsx("span",{className:"news-sent pos",children:"▲"}),a==="neg"&&e.jsx("span",{className:"news-sent neg",children:"▼"}),e.jsx("span",{className:"news-time",children:ce(o.publishedAt)})]}),e.jsx("div",{className:"news-headline",children:o.headline})]},o.id)}),e.jsx("style",{children:`
      ...
      `})]})}const me=new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});function xe(r){return r>=1e3?new Intl.NumberFormat("en-US",{maximumFractionDigits:0}).format(r):me.format(r)}function pe({items:r}){return e.jsxs("div",{className:"comm-table",children:[r.map(o=>e.jsxs("div",{className:"comm-row",children:[e.jsx("div",{className:"comm-name",children:o.name}),e.jsxs("div",{className:"comm-unit",children:["/",o.unit]}),e.jsxs("div",{className:"comm-price",children:["$",xe(o.price)]}),e.jsxs("div",{className:`comm-chg ${o.changePct>=0?"up":"down"}`,children:[o.changePct>=0?"+":"",o.changePct.toFixed(2),"%"]})]},o.id)),e.jsx("style",{children:`
        .comm-table {
          display: flex;
      ...
      `})]})}function ge(r){return r.id==="us10y"?r.value.toFixed(2)+"%":r.id==="vix"||r.id==="dxy"?r.value.toFixed(2):r.value>=1e4?new Intl.NumberFormat("en-US",{maximumFractionDigits:0}).format(r.value):r.value>=1e3?new Intl.NumberFormat("en-US",{maximumFractionDigits:1}).format(r.value):r.value.toFixed(2)}function ue({m:r}){const o=r.id==="vix"?r.changePct<=0:r.changePct>=0,a=r.changePct>=0?"+":"";return e.jsxs("div",{className:"gm-item",children:[e.jsx("span",{className:"gm-name",children:r.name}),e.jsx("span",{className:"gm-value",children:ge(r)}),e.jsxs("span",{className:`gm-pct ${o?"up":"down"}`,children:[a,r.changePct.toFixed(2),"%"]})]})}function fe(){const{data:r}=x({queryKey:["global-markets"],queryFn:R,staleTime:6e4,refetchInterval:6e4});return r?.length?e.jsxs("div",{className:"gm-bar",children:[e.jsx("div",{className:"gm-label",children:"GLOBAL"}),e.jsx("div",{className:"gm-scroll",children:r.map(o=>e.jsx(ue,{m:o},o.id))}),e.jsx("style",{children:`
        .gm-bar {
          display: flex;
          align-items: stretch;
